...
const uint8_t m_aucIntPri[BUTT_IRQN] = {
    ...
    OS_HWI_PRIO_LOWEST,      // reserved                          = 19,
    ...
    OS_HWI_PRIO_LOWEST,      // reserved                          = 32,
    ...
    OS_HWI_PRIO_LOWEST,      // reserved                          = 54,
    OS_HWI_PRIO_LOWEST,      // S1_MONITOR_INT|S4_MONITOR_INT     = 55,
    OS_HWI_PRIO_LOWEST,      // reserved                          = 56,
    OS_HWI_PRIO_LOWEST,      // PULSE_CAPTURE_INT                 = 57,
    OS_HWI_PRIO_LOWEST,      // reserved                          = 58,
