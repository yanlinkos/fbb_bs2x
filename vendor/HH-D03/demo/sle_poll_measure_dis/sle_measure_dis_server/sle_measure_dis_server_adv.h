...
#define HCI_GLE_ADV_FILTER_SIZE                     60/*定义了BLE广告过滤规则条目的最大长度（以字节为单位）。在BLE中，广告过滤规则可能包括一个操作码（action）、一个索引（index）、制造商数据（Manufacturer Data）及其掩码（Manufacturer Data Mask）。*/
